...
board::board() :woc(0), boc(0) {
    char r = 'M';
    for (int i = 0;i < 13;i++) {
        if (i < 6) { //board has increased it height so starting at 6
...
void board::refreshOffboardCounts(string& winner_, const string& player1, const string& player2) {
    int wOnBoard = 0;
    int bOnBoard = 0;
