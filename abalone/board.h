...
public:
    ...
    explicit operator std::string() const;//cast this object into a string.
    ...
    void refreshOffboardCounts(string& winner_, const string& player1, const string& player2);//checks how many white and black marbles are still in the board and updates woc and boc accordingly
    int white() const;
    int black() const;
};
